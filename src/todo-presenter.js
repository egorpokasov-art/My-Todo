export class TodoPresenter {
  infoMessages = {
    ...
    get all() {
      ...
      <div class="info">
        ...
        <svg 
        class="info__image ${this.themeColor}" data-theme
          width="50px" height="50px" viewBox="0 0 24 24" fill="none"
          xmlns="http://www.w3.org/2000/svg">
          <path d="M11 6L21 6.00072M11 12L21 12.0007M11 18L21 18.0007M3 
    ...
    get active() {
      ...
      <div class="info">
        ...
        <!DOCTYPE>
        <svg 
          class="info__image ${this.themeColor}" 
          data-theme 
          fill="currentColor" 
    ...
    get filtered() {
      ...
      <svg 
        class="info__image ${this.themeColor}" 
        data-theme  
        fill="currentColor" width="50px" height="50px" viewBox="0 0 36 36"
        version="1.1" preserveAspectRatio="xMidYMid meet"
        xmlns="http://www.w3.org/2000/svg"
      >
        <title>sad-face-solid</title>
        <path  
          d="M18,2A16,16,0,1,0,34,18,16,16,0,0,0,18,2Zm9,12.28a1.8,1.8,0,1,1-1.8-1.8A1.8,1.8,0,0,1,27,14.28Zm-15.55,1.8a1.8,1.8,0,1,1,1.8-1.8A1.8,1.8,0,0,1,11.41,16.08Zm14,7.53a1,1,0,0,1-1.6,1.2,7,7,0,0,0-11.31.13,1,1,0,1,1-1.63-1.16,9,9,0,0,1,14.54-.17Z"
  ...
  constructor(todoModel, todoUi) {
    ...
    this.infoMessages.themeColor = this.todoModel.getThemeColor()
  }
  ...
  updateState() {
    ...
    this.infoMessages.themeColor = this.state.themeColor
  }
